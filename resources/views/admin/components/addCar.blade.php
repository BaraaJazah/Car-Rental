        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('move.AddCarAdminPage') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="defaultFormControlInput8" class="form-label">Minimum yaşa</label>
                    ...
                    <div class="mb-3">
                        <label for="defaultFormControlInput9" class="form-label">minimum ahliyet yil</label>
                ...
                @foreach ($cars as $driver)
                    <div class="tab-pane fade" id="navs-pills-{{ $driver['pointId'] }}" role="tabpanel">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class=" mb-4">
                                <h5 class="card-header">ARACŞLAR</h5>
