    ...
    @if (Session::has('ErrorMsg'))
        <div style="width: 100%; display: flex; justify-content: center ">
            <div class="alert alert-warning alert-dismissible fade show"
                ...
                role="alert">
                <strong>No Cars : </strong> {{ Session::get('ErrorMsg') }}
...
@section('content')
                            ...
                            <div class="row g-5">
                                <div class="col-lg-6 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s"
                                    ...
                                    <div class="bg-secondary rounded p-5">
                                        ...
                                        <form method="POST" action="{{ route('user.searchArac') }}">
                                            @csrf
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="driver" id="same-address">
                                                            <label class="custom-control-label" for="same-address">
                                                                Bir Sürücüye İhtiyacım Var
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <button class="btn btn-light w-100 py-2">Kiralık araç ara</button>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div class="categories-item p-4">
                                <div class="categories-item-inner">
                                    ...
                                    <div class="categories-content rounded-bottom p-4 overFifo">
                                        ...
                                        <div class="row gy-2 gx-0 text-center mb-4">
                                            ...
                                            <div class="col-4 border-end border-white">
                                                <i class="fa fa-car text-dark"></i> <span
                                                    class="text-body ms-1">AT/MT</span>
                                            </div>
                                        ...
                                        <form method="post" action="{{ route('move.featurePage') }}">
                                            @csrf
                                            @if ($request != [])
                                                <input type="hidden" name="alisYeri" value="{{ $request->alisYeri }}">
                                                <input type="hidden" name="alisTarihi"
                                                    value="{{ $request->alisTarihi }}">
                                                <input type="hidden" name="alisSaati"
                                                    value="{{ $request->alisSaati }}">
                                                <input type="hidden" name="verisTarihi"
                                                    value="{{ $request->verisTarihi }}">
                                                <input type="hidden" name="verisSaati"
                                                    value="{{ $request->verisSaati }}">
    ...
    @elseif ($cars = ['no'])
    @else
        <div class="alert alert-danger" style="margin: 20px; text-align: center" role="alert">
            Müsait arabalar bulunamıyor
        </div>
