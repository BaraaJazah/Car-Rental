            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="{{ route('dashboard') }}" class="nav-item nav-link nav-link-item">Home</a>
                        <a href="{{ route('move.carsPage') }}" class="nav-item nav-link nav-link-item">My Car</a>
                        <a href="{{ route('move.aboutPage') }}" class="nav-item nav-link nav-link-item">About</a>
                        <a href="{{ route('move.servicePage') }}" class="nav-item nav-link nav-link-item">Service</a>
                        <a href="{{ route('move.contactPage') }}" class="nav-item nav-link nav-link-item">Contact</a>
                    </div>



                    <div style="display: flex; justify-content: center; align-items: center">
                        <p class="btn rounded-pill py-2 px-4;" style="margin: 0;cursor: default ; text-transform: capitalize">Welcome <br> {{ Auth::user()->name }} {{ Auth::user()->surname }}</p>

                        <img style="border-radius: 50% ; height: 80px; width: 80px;" src="assets/{{ Auth::user()->photo }}"
                            alt="">
                    </div>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="btn btn-primary rounded-pill py-2 px-4" style="margin: 0 ; padding: 0">Log Out</button>
                    </form>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
