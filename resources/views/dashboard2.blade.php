            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="{{ route('move.indexPage') }}" class="nav-item nav-link nav-link-item">Home</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="{{ route('move.featurePage') }}" class="dropdown-item nav-link-item">Our
                                    Feature</a>
                                <a href="{{ route('move.carsPage') }}" class="dropdown-item nav-link-item">Our Cars</a>
                            </div>
                        </div>
                        <a href="{{ route('move.contactPage') }}" class="nav-item nav-link nav-link-item">Contact</a>
                    </div>

                    <a class="btn btn-primary rounded-pill py-2 px-4" style="margin: 0px 10px">Login</a>
                    <a class="btn btn-primary rounded-pill py-2 px-4">Register</a>
