                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="{{ route('move.indexWelcome') }}"
                            class="nav-item nav-link nav-link-item active">Home</a>
                        <a href="{{ route('move.aboutWelcome') }}" class="nav-item nav-link nav-link-item">About</a>
                        <a href="{{ route('move.serviceWelcome') }}" class="nav-item nav-link nav-link-item">Service</a>
                        <a href="{{ route('move.contactWelcome') }}" class="nav-item nav-link nav-link-item">Contact</a>
